...
namespace Smartkernel.Framework.ObjectPool
{
    ...
    public class SmartAutoOverTimeConcurrentDictionaryObjectPool<TKey, TValue> : IDisposable where TValue : SmartAutoOverTimeConcurrentDictionaryObjectPoolValue
    {
        ...
        public SmartAutoOverTimeConcurrentDictionaryObjectPool(double overTimeInterval, double clearInterval)
        {
