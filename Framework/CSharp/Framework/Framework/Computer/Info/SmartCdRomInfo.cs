...
namespace Smartkernel.Framework.Computer.Info
{
	...
	/// 获取CDRomInfo
	/// </summary>
	public class SmartCdRomInfo : SmartInfo
	{
		/// <summary>
		/// 构造函数
		/// </summary>
		/// <param name="infos">信息列表</param>
		public SmartCdRomInfo(Dictionary<string, string> infos)
			: base(infos)
		{
		}
		...
		/// 获取Drive
		/// </summary>
		public string Drive { get { return Infos["Drive"]; } }

		/// <summary>
		/// 获取DriveIntegrity
		/// </summary>
		public string DriveIntegrity { get { return Infos["DriveIntegrity"]; } }
		...
		/// 获取FileSystemFlags
		/// </summary>
		public string FileSystemFlags { get { return Infos["FileSystemFlags"]; } }

		/// <summary>
		/// 获取FileSystemFlagsEx
		/// </summary>
		public string FileSystemFlagsEx { get { return Infos["FileSystemFlagsEx"]; } }

		/// <summary>
		/// 获取Id
		/// </summary>
		public string ID { get { return Infos["Id"]; } }
		...
		/// <summary>
		/// 获取MfrAssignedRevisionLevel
		/// </summary>
		public string MfrAssignedRevisionLevel { get { return Infos["MfrAssignedRevisionLevel"]; } }
		...
		/// 获取RevisionLevel
		/// </summary>
		public string RevisionLevel { get { return Infos["RevisionLevel"]; } }
		...
		/// 获取TransferRate
		/// </summary>
		public string TransferRate { get { return Infos["TransferRate"]; } }
